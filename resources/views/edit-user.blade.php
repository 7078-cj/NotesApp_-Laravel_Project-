    ...
    <div class="p-6 space-y-6">
        <form action="/updateUser/{{ $user->id }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-6 gap-6">
                ...
                @if ($user->avatar)
                    <img src="{{ asset('storage/' . $user->avatar) }}" alt=""style="width:200px;height:200px">
                @endif
                <div class="col-span-6 sm:col-span-3">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="password" name="password"  class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"  >
                </div>
