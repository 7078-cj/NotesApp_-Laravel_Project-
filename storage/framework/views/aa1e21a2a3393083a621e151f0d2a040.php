    ...
    <div class="p-4">
      <div class="flex flex-row justify-end gap-4">
        ...
        <div class="mb-4 rounded-full <?php echo e($note->visibility=="public" ? "bg-blue-400":"bg-red-400"); ?> py-0.5 px-2.5 border border-transparent text-xs text-white transition-all shadow-sm w-20 text-center">
          ...
          <?php if(Auth::user() && Auth::user()->Bookmarks->contains('note_id',$note->id)): ?>
              <?php
            ...
            <form action="/delete-bookmark/<?php echo e($bookmark->id); ?>" method="post">
              ...
              <?php else: ?>
              <form action="/bookmark/<?php echo e($note->id); ?>" method="post">
                <?php echo csrf_field(); ?>
                <button type="submit">
...
</a><?php /**PATH C:\Users\santo\OneDrive\Desktop\php-laravel\NotesApp - Copy\resources\views/components/notesCard.blade.php ENDPATH**/ ?>