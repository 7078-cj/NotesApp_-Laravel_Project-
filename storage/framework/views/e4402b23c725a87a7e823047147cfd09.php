        ...
        <div class="flex-1 flex-row items-center justify-center bg-slate-50">
            ...
            <div class="flex flex-row gap-3 items-center justify-center text-center mt-4 text-gray-600">
                <h3 class="flex flex-row items-center justify-center text-center">Notes Creator: <?php if($note->user->avatar): ?>
                    <img src="<?php echo e(asset('storage/' . $note->user->avatar)); ?>" alt="" class="h-40 w-40 rounded-full p-4">
                <?php endif; ?><?php echo e($note->user->name); ?></h3>
                |
                <h3> email:<?php echo e($note->user->email); ?></h3>
                </div>
            </div>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\santo\OneDrive\Desktop\php-laravel\NotesApp\resources\views/note.blade.php ENDPATH**/ ?>