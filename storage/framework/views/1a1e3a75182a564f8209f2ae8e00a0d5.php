    ...
    <div class="bg-white p-10 sm:p-6 font-robotoMono">
      <div class="flex flex-row flex-wrap justify-center gap-5 items-center">
        ...
        <div class="mt-0.5 text-lg text-gray-900  gap-3 m-5 flex flex-col"> 
            ...
            <?php endif; ?>
            <p class=" text-gray-600 m-1 break-words text-center"><?php echo e($body->message); ?> </p>
...
<?php /**PATH C:\Users\santo\OneDrive\Desktop\php-laravel\NotesApp - Copy\resources\views/components/bodyCard.blade.php ENDPATH**/ ?>