                                    ...
                                    <div class = "headTags personal">
                                        <p><a href="/" class="flex flex-row gap-2 items-center justify-center ">
                                            <span class="bg-blue-500 border-white rounded p-2 m-2 shadow w-full text-center px-4 py-2">
                                                <?php echo e(Auth::user()->name); ?>'s Notes
                                            </span></a></p>
                                    </div>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\santo\OneDrive\Desktop\php-laravel\NotesApp - Copy\resources\views/components/navbar.blade.php ENDPATH**/ ?>