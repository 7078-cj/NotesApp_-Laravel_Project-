...
<div class="flex flex-col items-center justify-center flex-1 gap-3 max-h-full bg-gradient-to-b from-indigo-500 to-sky-300">
        ...
        <h1 class="p-5 bg-slate-100 m-4 rounded-md text-lg">BookMarks</h1>
        <div class="min-h-screen pt-4">
              <div class="flex flex-row flex-1 gap-11 flex-wrap items-center justify-center  ">
                ...
                <?php echo $__env->make('components.bookMarkCard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\santo\OneDrive\Desktop\php-laravel\NotesApp - Copy\resources\views/bookMarks.blade.php ENDPATH**/ ?>