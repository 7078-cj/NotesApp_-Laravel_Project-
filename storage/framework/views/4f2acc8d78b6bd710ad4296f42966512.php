        ...
        <form action="/updates-body/<?php echo e($body->id); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 sm:col-span-3">
                    <label for="product-name" class="text-sm font-medium text-gray-900 block mb-2">Insert Pic</label>
                ...
                <div class="flex flex-wrap w-64 h-64">
                    <img src="<?php echo e(asset('storage/' . $body->image)); ?>" alt="" class="w-full">
                </div>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\santo\OneDrive\Desktop\php-laravel\NotesApp\resources\views/updateBody.blade.php ENDPATH**/ ?>